...
class GaussianDiffusion:
    ...
    def training_losses(self, model, *args, **kwargs):
        self.model = model
        x_start, t, private = args
        return self.training_losses_seq2seq(model, x_start, t, private, **kwargs)
    ...
    def p_sample_loop_progressive(
        ...
        if progress:
            ...
            indices = tqdm(indices, leave=True, position=0)
    ...
    def training_losses_seq2seq(self, model, x_start, t, private, model_kwargs=None, noise=None):
        """
